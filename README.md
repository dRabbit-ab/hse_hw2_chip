...
Выводы:
Для первого графика можно с натяжкой заключить о совпадении расположения гистоновой метки относительно референтного генома, для второго же сделать этого не получится.
